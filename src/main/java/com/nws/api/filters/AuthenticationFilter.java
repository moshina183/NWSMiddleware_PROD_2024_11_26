...
public class AuthenticationFilter {
	...
	public String isWhiteListed(String consumerCode, String serviceCode, String esb_category_code) throws Exception {
		...
		if (null == consumerServiceDetails) {
			...
			System.out.println("Esle part of whitlisted");
	...
	public ConsumerServiceDetail checkConsumerAccess(String consumerCode, String serviceCode, String esb_category_code)
			throws Exception {
		System.out.println("Begin ConsumerServiceDetail: " + consumerCode + " : " + serviceCode + " : " + esb_category_code);
		ConnectionHelper conHelper = new ConnectionHelper();
		Connection con = null;
		...
		try {
			...
			System.out.println("hasRow: "+hasRow);
			String status = hasRow ? "Allowed" : "NotAllowed";
			System.out.println("status: "+status);
			if (status.equalsIgnoreCase("Allowed")) {
				ConsumerServiceDetail csDetails = new ConsumerServiceDetail();
				System.out.println("Consumer Allowed for SOP " + serviceCode);
			...
			System.out.println("error in RS details: ");
			e.getMessage();
		} finally {
			conHelper.releaseConnection(con);
			rs.close(); 
